...
// P0-A2 enables the local Companion Gateway and true microphone / speaker audio.
...
// P0-A2.1 adds a moderate analog PGA boost for near-field speech.
...
#define AUDIO_SPEAKER_VOLUME 255       // P0 real-voice baseline, validated on-device
#define AUDIO_SPEAKER_MAGNIFICATION 4  // P0 real-voice baseline, validated on-device

// Idle mascot micro-animation.
#define IDLE_BLINK_INTERVAL_MS 4200
#define IDLE_BLINK_DURATION_MS 150

// P0-A3.7 brownout root fix.
...
#define AUDIO_PTT_BUFFER_BYTES ((AUDIO_MIC_SAMPLE_RATE * 2 * AUDIO_MAX_PTT_MS) / 1000)
